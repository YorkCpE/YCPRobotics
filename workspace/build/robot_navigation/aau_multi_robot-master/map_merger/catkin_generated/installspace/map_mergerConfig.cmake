...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_merger' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/carasperbeck/ros_ws/install/${idir}'.  Ask the maintainer 'Peter Kohout <peter_kohout@gmx.at>' to fix it.")
    endif()
