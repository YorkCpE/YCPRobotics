...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'FirstLaunchFile' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/carasperbeck/ros_ws/src/agitr/FirstLaunchFile/${idir}'.  Ask the maintainer 'carasperbeck <csperbec@ycp.edu>' to fix it.")
    endif()
