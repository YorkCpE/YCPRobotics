...
if("TRUE" STREQUAL "TRUE")
  set(map_merger_SOURCE_PREFIX /home/carasperbeck/ros_ws/src/robot_navigation/aau_multi_robot-master/map_merger)
  set(map_merger_DEVEL_PREFIX /home/carasperbeck/ros_ws/devel)
  ...
  set(map_merger_INSTALL_PREFIX /home/carasperbeck/ros_ws/install)
...
if(NOT "/home/carasperbeck/ros_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_merger' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/carasperbeck/ros_ws/src/robot_navigation/aau_multi_robot-master/map_merger/${idir}'.  Ask the maintainer 'Peter Kohout <peter_kohout@gmx.at>' to fix it.")
    endif()
...
set(map_merger_EXPORTED_TARGETS "map_merger_generate_messages_cpp;map_merger_generate_messages_lisp;map_merger_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${map_merger_dep}_FOUND)
      find_package(${map_merger_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${map_merger_dep} REQUIRED ${depend_list})
  endif()
